...
if __name__ == '__main__':
    ...
    op.add_option('-s','--spectra', dest='spectra_file', default=None, help='the original spectra file(.mzml) to count the number of spectras')
