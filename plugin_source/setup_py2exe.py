...
setup(
    console=['WeightedSimilarityMatrix.py', 'AbundanceCorrection.py', 'ExcludePeptides.py', 'CountPeptides.py', 'ConcatenateFiles.py', 'IdxmlToFasta.py', 'SixFrameTranslation.py'],
    options={
        'py2exe':{
